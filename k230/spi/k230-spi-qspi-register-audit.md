...
- 英文原始 TRM：[K230 Technical Reference Manual V0.3.1](../reference/K230_Technical_Reference_Manual_V0.3.1_20241118.txt)，重点为 12.3 SPI（PDF 778--808 页）和 5.3 FMC/XIP。
...
- 逐位依据和条件布局见既有学习文档：[TRM 12.3 中文对照](reference/k230-trm-12.3-spi-cn.md)。该文档用于定位，不以 QEMU 实现反证硬件。
